...
public class UsuarioService implements UserDetailsService
{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		/*Que pasa si ocurriera un error por ejemplo no se encuentra el usuario*/
		if (usuario == null) {
		...
		List<GrantedAuthority> authorities = usuario.getRoles().stream()
				...
				//mostrar el nombre del rol del usuario autenticado para eso
				//usamos expresion lambda.
				.peek(authority -> log.info("Role: " + authority.getAuthority()))
				//Como sigue siendo un Stream hay que volver a convertir a
